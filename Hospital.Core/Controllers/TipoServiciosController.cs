...
namespace Hospital.Core.Controllers
{
    ...
    public class TipoServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Descripcion,Id,Estado")] TipoServicio tipoServicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Descripcion,Id,Estado")] TipoServicio tipoServicio)
        {
